# Operator Quickstart — Community Electronic and Optical Equipment Repair Operations

Shortest path from clone to a verified local dry-run for **ISIC 3313** (`cloud-itonami-isic-3313`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3313.git
cd cloud-itonami-isic-3313
```
...
- Blueprint governor key: `electronic-repair-governor`
- Likely source path: `electronicrepair.governor.cljc`
